...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-12l1.09 2.18L12 12l-1.09 2.18L10 17l-2.18-1.09L6 14l2.18-1.09L10 11.82zM19 3v4m-2 2h4m-1 12l-1.09-2.18L16 14l-1.09-2.18L14 10l2.18-1.09L18 6l2.18 1.09L22 10l-2.18 1.09z" />
    </svg>
);
